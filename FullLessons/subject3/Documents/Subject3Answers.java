...
public class Subject3Answers {
    public static void main(String[] args) {
        // Activity 1: Whiteboarding a simple Object - Subject Animal (NO CODE)
        /**
         * String name = "";               // Bingo, Bluey, Bandit, Chilli
         * String classification = "";     // mammal, reptile, fish, bird
         * String commonType == "";        // dog, cat, goldfish, kangaroo
         * int numberLegs = 0;             // 0, 2, 4  ???
         * int age = 0;                    // ???
         * double movementSpeedMph = 0.0;  // 14.7     ???
         * boolean friendlyStatus = true;  // true / false
         */
        ...
        String myString = "This is a simple string in a variable";
        System.out.println(myString);

        // Activity 4: Concating String Variables
        String myGreeting = "Hi, my name is";
        String myName = "Zach Stanfill";
        System.out.println(myGreeting + " " + myName);
