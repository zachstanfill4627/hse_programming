...
lightsOn = True  # This can be set to True or False
print("Value of lightsOn variable:", lightsOn)
...
"""
print("1st Conditional: ", end="")  # Use end="" to avoid newline

if lightsOn:
  print("The lights in the room are on")
...
print("2nd Conditional: ", end="")

if lightsOn:
  print("The lights in the room are on")
else:
  print("The lights in the room are off")
...
if lightsOn and not roomOccupied:
  print("We should turn the lights off because the room is empty")
elif not lightsOn and roomOccupied:
  print("We should turn the lights on because the room is occupied")
else:
  print("Lets just leave the lights alone")
